<template>
    <div class="panel panel-default">
        ...
        <div class="self-card">
            <p>What a self-made card !</p>
            <button class="btn btn-primary btn-lg" style="margin: 10px" @click="onAnswer(true)">Flip to my Momma!</button>
